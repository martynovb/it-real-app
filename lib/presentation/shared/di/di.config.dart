...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.ImagePicker>(() => appModule.imagePicker);
    gh.factory<_i4.OnboardingBloc>(() => _i4.OnboardingBloc());
    gh.singleton<_i5.SupabaseClient>(() => dataModule.supabase);
    gh.singleton<_i6.AppBloc>(() => _i6.AppBloc());
    gh.factory<_i7.DragAndDropBloc>(
        () => _i7.DragAndDropBloc(imagePicker: gh<_i3.ImagePicker>()));
    gh.singleton<_i8.ProductsDataSource>(
        () => _i9.ProductsRepo(supabaseClient: gh<_i5.SupabaseClient>()));
    gh.singleton<_i10.VerificationDataSource>(
        () => _i11.VerificationRepo(supabaseClient: gh<_i5.SupabaseClient>()));
    ...
    gh.singleton<_i13.AuthDataSource>(
        () => _i14.AuthRepo(supabaseClient: gh<_i5.SupabaseClient>()));
    ...
    gh.factory<_i18.ForgotPasswordBloc>(() =>
        _i18.ForgotPasswordBloc(authDataSource: gh<_i13.AuthDataSource>()));
    ...
    gh.singleton<_i21.AuthBloc>(() => _i21.AuthBloc(
          ...
          supabaseClient: gh<_i5.SupabaseClient>(),
        ));
