...
class _$TokensStateImpl implements _TokensState {
  const _$TokensStateImpl({required this.status, required this.errorMessage});
  ...
  @override
  String toString() {
    return 'TokensState(status: $status, errorMessage: $errorMessage)';
  }
...
abstract class _TokensState implements TokensState {
  const factory _TokensState(
      ...
      required final String? errorMessage}) = _$TokensStateImpl;
